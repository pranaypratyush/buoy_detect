...
"""autogenerated by genpy from kraken_msgs/scanAction.msg. Do not edit."""
import sys
...
class scanAction(genpy.Message):
  _md5sum = "ee61009df6c0364aa8c1f834544c1941"
  _type = "kraken_msgs/scanAction"
...
"""
  ...
  _slot_types = ['kraken_msgs/scanActionGoal','kraken_msgs/scanActionResult','kraken_msgs/scanActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(scanAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = kraken_msgs.msg.scanActionGoal()
      if self.action_result is None:
        self.action_result = kraken_msgs.msg.scanActionResult()
      if self.action_feedback is None:
        self.action_feedback = kraken_msgs.msg.scanActionFeedback()
    else:
      self.action_goal = kraken_msgs.msg.scanActionGoal()
      self.action_result = kraken_msgs.msg.scanActionResult()
      self.action_feedback = kraken_msgs.msg.scanActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_if3I.pack(_x.action_goal.goal.direction, _x.action_goal.goal.speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.direction, _x.action_goal.goal.speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_if3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
