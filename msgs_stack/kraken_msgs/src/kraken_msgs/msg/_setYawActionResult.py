...
"""autogenerated by genpy from kraken_msgs/setYawActionResult.msg. Do not edit."""
import sys
...
class setYawActionResult(genpy.Message):
  _md5sum = "2d51b835f242b017c69e8cd703afb60a"
  _type = "kraken_msgs/setYawActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kraken_msgs/setYawResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(setYawActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kraken_msgs.msg.setYawResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kraken_msgs.msg.setYawResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.result.elapsed_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.elapsed_time,) = _struct_f.unpack(str[start:end])
      return self
