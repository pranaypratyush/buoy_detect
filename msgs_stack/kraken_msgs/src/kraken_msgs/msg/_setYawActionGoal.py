...
"""autogenerated by genpy from kraken_msgs/setYawActionGoal.msg. Do not edit."""
import sys
...
class setYawActionGoal(genpy.Message):
  _md5sum = "11f048d416dc6cbf8d155a2daf72e62b"
  _type = "kraken_msgs/setYawActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','kraken_msgs/setYawGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(setYawActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = kraken_msgs.msg.setYawGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = kraken_msgs.msg.setYawGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.goal.yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.yaw,) = _struct_f.unpack(str[start:end])
      return self
