...
"""autogenerated by genpy from kraken_msgs/scanActionFeedback.msg. Do not edit."""
import sys
...
class scanActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "kraken_msgs/scanActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kraken_msgs/scanFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(scanActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = kraken_msgs.msg.scanFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kraken_msgs.msg.scanFeedback()
