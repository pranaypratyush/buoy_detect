...
"""autogenerated by genpy from kraken_msgs/setYawAction.msg. Do not edit."""
import sys
...
class setYawAction(genpy.Message):
  _md5sum = "e3eb2f5154a19588da8dd33aaf392389"
  _type = "kraken_msgs/setYawAction"
...
"""
  ...
  _slot_types = ['kraken_msgs/setYawActionGoal','kraken_msgs/setYawActionResult','kraken_msgs/setYawActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(setYawAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = kraken_msgs.msg.setYawActionGoal()
      if self.action_result is None:
        self.action_result = kraken_msgs.msg.setYawActionResult()
      if self.action_feedback is None:
        self.action_feedback = kraken_msgs.msg.setYawActionFeedback()
    else:
      self.action_goal = kraken_msgs.msg.setYawActionGoal()
      self.action_result = kraken_msgs.msg.setYawActionResult()
      self.action_feedback = kraken_msgs.msg.setYawActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_f3I.pack(_x.action_goal.goal.yaw, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_f3I.pack(_x.action_result.result.elapsed_time, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3f.pack(_x.action_feedback.feedback.Desired_yaw, _x.action_feedback.feedback.Current_yaw, _x.action_feedback.feedback.Error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.yaw, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.elapsed_time, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.Desired_yaw, _x.action_feedback.feedback.Current_yaw, _x.action_feedback.feedback.Error,) = _struct_3f.unpack(str[start:end])
      return self
