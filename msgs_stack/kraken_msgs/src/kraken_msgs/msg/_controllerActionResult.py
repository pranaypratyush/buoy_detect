...
"""autogenerated by genpy from kraken_msgs/controllerActionResult.msg. Do not edit."""
import sys
...
class controllerActionResult(genpy.Message):
  _md5sum = "c77370f28cdda6dc3cef03fbf32f4697"
  _type = "kraken_msgs/controllerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kraken_msgs/controllerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(controllerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kraken_msgs.msg.controllerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kraken_msgs.msg.controllerResult()
