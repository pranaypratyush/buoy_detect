...
"""autogenerated by genpy from kraken_msgs/scanActionResult.msg. Do not edit."""
import sys
...
class scanActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "kraken_msgs/scanActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kraken_msgs/scanResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(scanActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kraken_msgs.msg.scanResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kraken_msgs.msg.scanResult()
