...
"""autogenerated by genpy from kraken_msgs/controllerActionFeedback.msg. Do not edit."""
import sys
...
class controllerActionFeedback(genpy.Message):
  _md5sum = "e6427d3342d0e75e077f14836482f587"
  _type = "kraken_msgs/controllerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kraken_msgs/controllerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(controllerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = kraken_msgs.msg.controllerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kraken_msgs.msg.controllerFeedback()
