...
"""autogenerated by genpy from kraken_msgs/advancedControllerAction.msg. Do not edit."""
import sys
...
class advancedControllerAction(genpy.Message):
  _md5sum = "5f1dac409ce5eb11f676dcefebddfb64"
  _type = "kraken_msgs/advancedControllerAction"
...
"""
  ...
  _slot_types = ['kraken_msgs/advancedControllerActionGoal','kraken_msgs/advancedControllerActionResult','kraken_msgs/advancedControllerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(advancedControllerAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = kraken_msgs.msg.advancedControllerActionGoal()
      if self.action_result is None:
        self.action_result = kraken_msgs.msg.advancedControllerActionResult()
      if self.action_feedback is None:
        self.action_feedback = kraken_msgs.msg.advancedControllerActionFeedback()
    else:
      self.action_goal = kraken_msgs.msg.advancedControllerActionGoal()
      self.action_result = kraken_msgs.msg.advancedControllerActionResult()
      self.action_feedback = kraken_msgs.msg.advancedControllerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3f3I.pack(_x.action_goal.goal.flag, _x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.depth, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.flag, _x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.depth, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
