...
(cl:defmethod flag-val ((m <advancedControllerGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kraken_msgs-msg:flag-val is deprecated.  Use kraken_msgs-msg:flag instead.")
  (flag m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<advancedControllerGoal>)))
  ...
  "757d1c6f47df020d70637830ba957a9d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'advancedControllerGoal)))
  "Returns md5sum for a message object of type 'advancedControllerGoal"
  "757d1c6f47df020d70637830ba957a9d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<advancedControllerGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal~%int32 flag ##flag==0 means global destination and flag==1 means local destination~%float32 x~%float32 y~%float32 depth~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'advancedControllerGoal)))
  "Returns full string definition for message of type 'advancedControllerGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal~%int32 flag ##flag==0 means global destination and flag==1 means local destination~%float32 x~%float32 y~%float32 depth~%~%~%~%"))
